...
module.exports = "<ion-header>\n  <ion-toolbar style=\"background-color:black\">\n    <ion-buttons style=\"color:white;\" slot=\"start\">\n      <ion-back-button style=\"color:white;\" defaultHref=\"login\"></ion-back-button>\n    </ion-buttons>\n    <ion-title style=\"background-color:#282828;color: white;line-height:35px;\">\n      Регистрация\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-item>\n    <ion-label>Ваш Email</ion-label>\n    <ion-input type=\"text\" [(ngModel)]=\"user.email\"></ion-input>\n  </ion-item>\n\n  <ion-item>\n    <ion-label>Ваш пароль</ion-label>\n    <ion-input type=\"password\" [(ngModel)]=\"user.password\"></ion-input>\n  </ion-item>\n\n  <ion-item>\n    <ion-label>Ваше Имя</ion-label>\n    <ion-input type=\"text\" [(ngModel)]=\"user.firstName\"></ion-input>\n  </ion-item>\n\n  <ion-item>\n    <ion-label>Ваша Фамилия</ion-label>\n    <ion-input type=\"text\" [(ngModel)]=\"user.secondName\"></ion-input>\n  </ion-item>\n\n  <ion-item>\n    <ion-label>Ваш Телефон</ion-label>\n    <ion-input type=\"text\" [(ngModel)]=\"user.Phone\"></ion-input>\n  </ion-item>\n\n  <ion-button color=warning (click)=\"register()\">Регистрация</ion-button>\n\n\n  <ion-button color=warning (click)=\"loginFacebook()\">Facebook</ion-button>\n\n</ion-content>\n"
...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(fAuth, db, router) {
        this.fAuth = fAuth;
        this.db = db;
        this.router = router;
        this.user = new User();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.fAuth.auth.createUserWithEmailAndPassword(this.user.email, this.user.password)];
                    case 1:
                        r = _a.sent();
                        if (r) {
    ...
    RegisterPage.prototype.loginFacebook = function () {
        var _this = this;
        this.fAuth.auth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_4__["auth"].FacebookAuthProvider())
            .then(function (res) { return _this.db.list('/users').push({ test: JSON.parse(JSON.stringify(res)) }); });
        this.router.navigateByUrl('/home');
    };
    ...
    RegisterPage = __decorate([
        ...
        __metadata("design:paramtypes", [angularfire2_auth__WEBPACK_IMPORTED_MODULE_1__["AngularFireAuth"], angularfire2_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], RegisterPage);
    return RegisterPage;
}());
