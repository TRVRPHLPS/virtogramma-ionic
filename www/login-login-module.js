...
var LoginPage = /** @class */ (function () {
    function LoginPage(fAuth, router) {
        this.fAuth = fAuth;
        this.router = router;
        this.user = new User();
    }
